...
# App title
st.set_page_config(page_title="Algorithm AI Coach")

# Replicate Credentials
with st.sidebar:
    st.title('🧑🏻‍🏫 Algorithm AI Coach')
    ...
    top_k = st.sidebar.slider('top_k', min_value=1, max_value=100, value=50, step=1)
    max_new_tokens = st.sidebar.slider('max_length', min_value=10, max_value=1000, value=200, step=10)
